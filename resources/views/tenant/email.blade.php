                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <img alt="I'm an image"
                                                                        src="{{ asset('assets/email/images/Companify-Logo.png') }}"
                                                                        style="
                                                                                display: block;
                                                                                height: auto;
                                                                                border: 0;
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="
                                                                            line-height: 10px;
                                                                        ">
                                                                    <img alt="I'm an image" class="big"
                                                                        src="{{ asset('assets/email/images/Img4_2x.jpg') }}"
                                                                        style="
                                                                                display: block;
                                                                                height: auto;
                                                                                border: 0;
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="
                                                                        ...
                                                                        ">
                                                                    <img alt="I'm an image" class="big"
                                                                        src="{{ asset('assets/email/images/footer.png') }}"
                                                                        style="
                                                                                display: block;
                                                                                height: auto;
                                                                                border: 0;
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <img alt="Alternate text"
                                                                        src="{{ asset('assets/email/images/Logo-white.png') }}"
                                                                        style="
                                                                                display: block;
                                                                                height: auto;
                                                                                border: 0;
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                <a href="https://www.facebook.com/"
                                                                                    target="_blank"><img
                                                                                        ...
                                                                                        src="{{ asset('assets/email/images/facebook2x.png') }}"
                                                                                        style="
                                                                                                display: block;
                                                                                                height: auto;
                                                                                                border: 0;
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                <a href="https://twitter.com/"
                                                                                    target="_blank"><img
                                                                                        ...
                                                                                        src="{{ asset('assets/email/images/twitter2x.png') }}"
                                                                                        style="
                                                                                                display: block;
                                                                                                height: auto;
                                                                                                border: 0;
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                <a href="https://instagram.com/"
                                                                                    target="_blank"><img
                                                                                        ...
                                                                                        src="{{ asset('assets/email/images/instagram2x.png') }}"
                                                                                        style="
                                                                                                display: block;
                                                                                                height: auto;
                                                                                                border: 0;
                                                                            ...
                                                                            <td
                                                                                style="
                                                                                        padding: 0
                                                                                            ...
                                                                                            10px;
                                                                                    ">
                                                                                <a href="{{ asset('assets/email/images/linkedin2x.png') }}"
                                                                                    target="_blank"><img
                                                                                    ...
                                                                                    <td
                                                                                        ...
                                                                                        <a href="https://www.designedwithbee.com/"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                ...
                                                                                                class="icon"
                                                                                                height="32"
                                                                                                src="{{ asset('assets/email/images/bee.png') }}"
                                                                                                style="
                                                                                                        display: block;
                                                                                                        height: auto;
                                                                                                        margin: 0
