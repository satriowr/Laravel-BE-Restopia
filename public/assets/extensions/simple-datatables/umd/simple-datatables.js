                    ...
                    class o {
                        ...
                        render(t) {
                            ...
                            if (
                                ...
                                (a += "<div class='dataTable-top'>"),
                                (a += s.layout.top),
                                (a += "</div>"),
                                s.scrollY.length
                                    ? (a += `<div class='dataTable-container' style='height: ${s.scrollY}; overflow-Y: auto;'></div>`)
                                    : (a +=
                                          "<div class='dataTable-container'></div>"),
                                (a += "<div class='dataTable-bottom'>"),
                                (a += s.layout.bottom),
                                (a += "</div>"),
                                (a = a.replace(
                                    "{info}",
                        ...
                        renderPage() {
                            ...
                            if (
                                (this.totalPages &&
                                    ...
                                    (a = e * this.options.perPage),
                                    (i = a + this.pages[e].length),
                                    (a += 1),
                                    (t = this.searching
                        ...
                        renderPager() {
                            if ((s(this.pagers), this.totalPages > 1)) {
                                ...
                                this.options.firstLast &&
                                    s.appendChild(
                                        a(t, 1, this.options.firstText)
                                    ),
                                    this.options.nextPrev &&
                                        s.appendChild(
                                            a(t, i, this.options.prevText)
                                        );
                                let h = this.links;
                        ...
                        insert(s) {
                            ...
                            a.length &&
                                (this.rows().add(a), (this.hasRows = !0)),
                                this.update(),
                                this.setColumns(),
                                this.fixColumns();
                        }
                                    ...
                                    if ("txt" === o.type || "csv" === o.type) {
                                        for (l = "", n = 0; n < a.length; n++) {
                                            for (
                                                ...
                                                if (
                                                    !o.skipColumn.includes(
                                                        s[h].originalCellIndex
                                                    ) &&
                                                    this.columns(
                                                        s[h].originalCellIndex
                                                    ).visible()
